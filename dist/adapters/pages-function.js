...
import { formatForEmail, formatForEmailHtml } from '../server/format.js';
 ...
 */
export function attributionForNotification(body, options = {}) {
 ...
 */
export function isBodyTooLarge(contentLength, max = MAX_BODY_BYTES) {
    if (!contentLength)
        return false;
